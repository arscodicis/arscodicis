...
- ⚙️ Development tools/languages I have experience with: `Python`, `Java`, `C/C++`, `Kotlin`, `Swift`, `C#`, `VB.NET`. I've developed native apps for both `iOS` and `Android` systems. I also build tools to help me with development for both Windows and macOS. For Windows, I use Visual Studio, macOS I use Xcode. I have experience with VS Code, Android Studio, and IntelliJ. I'm looking forward to learning new ones too!
